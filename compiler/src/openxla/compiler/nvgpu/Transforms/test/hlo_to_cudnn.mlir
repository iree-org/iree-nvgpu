...
// CHECK: cudnn.graph @stablehlo.clamp(%[[ARG0:.*]]: !cudnn.tensor<1x8x16x32xf32, NHWC>)
...
// CHECK:      cudnn.graph @stablehlo.convolution(%[[ARG0]]: !cudnn.tensor<100x32x26x26xf32, NHWC>, %[[ARG1:.*]]: !cudnn.tensor<1x32x3x3xf32, NHWC>)
